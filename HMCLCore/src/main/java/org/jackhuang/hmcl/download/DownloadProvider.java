...
public interface DownloadProvider {
    ...
    /// the specific version list that this download provider provides. i.e. "fabric", "forge", "game", "optifine"
    ///
    /// @param id the id of specific version list that this download provider provides. i.e. "fabric", "forge", "game", "optifine"
